    ...
    <section className="pt-32 pb-20 relative overflow-hidden bg-gradient-to-br from-primary-900 to-secondary-900">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Conference Committees</h1>

          <p className="text-xl text-orange-100 mb-8 leading-relaxed">
            Meet the distinguished team of professionals who make ResGenXAI 2025 possible
          </p>
        </div>
      </div>
