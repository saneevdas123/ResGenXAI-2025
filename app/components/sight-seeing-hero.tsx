...
// Create a reusable NeuralNetworkAnimation component
    ...
    <section className="pt-32 pb-20 relative overflow-hidden bg-gradient-to-br from-primary-900 to-secondary-900">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Explore Odisha</h1>

          <p className="text-xl text-orange-100 mb-8 leading-relaxed">
            Discover the rich cultural heritage and breathtaking attractions of Odisha during your visit
          </p>
        </div>
      </div>
