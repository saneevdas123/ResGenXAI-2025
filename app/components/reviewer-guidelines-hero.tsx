...
export default function ReviewerGuidelinesHero() {
    ...
    <section className="pt-32 pb-20 relative overflow-hidden bg-gradient-to-br from-primary-900 to-secondary-900">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Reviewer Guidelines</h1>

          <p className="text-xl text-orange-100 mb-8 leading-relaxed">
            Guidelines and expectations for reviewers of ResGenXAI 2025 submissions
          </p>
        </div>
      </div>
